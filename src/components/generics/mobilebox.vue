<template>
    <div class="fl w-100">
        <div class="w-100 inline-flex items-center bw1 center ba b--black">
            ...
            <input placeholder="ENTER YOUR MOBILE NUMBER" class="mobile bg-transparent tc fw3 f4 tracked bn fl black pv3-ns pv2 ph1 w-80" type="number" pattern="\d*" minlength="11" maxlength="11" v-model="localMobile" @keyup="keyUP">
