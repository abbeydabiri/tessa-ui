    ...
    <section class="">
        ...
        <div class="fixed w-100 top-0 left-0 z-max">
            <div class="bg-black-90 w-100 vh-100 mw8 cf center absolute dn z-max top-0 left-0 right-0" :class="{'db':lMenu,'dn':!lMenu}">
                <div class=" vh-100 w-100 relative">

                    <i class="fal fa-times absolute z-max right-1 top-1 f2 fw6" @click="toggleMenu"></i>
                    <div class="mw8 cf w-100 " :class="{'slideInLeft':lMenu,'slideOutLeft':!lMenu}">
                        <nav class="vh-100 bg-main w-80 w-50-ns relative" > 

                            <div class="cf tc pa3 h3 bg-black-50 center w-100">
                            ...
                            <div class="bt b--mid-gray"> </div>

                            <div class="cf tr pa3 pl2 near-black bg-white f3 center w-100 fw6">
                            ...
                            <nav class="w-100 tc cf pv1 mw8 center fixed bottom-0 left-0 right-0 footer bg-black-60 inline-flex items-center">
            ...
            <div class="bg-black-80 w-100 vh-100 dn absolute z-max top-0 right-0 overflow-x-scroll pv2"  :class="{'slideInRight':lNotification,'slideOutRight':!lNotification}">
                <nav class="w-100 center cf fixed top-0 left-0  inline-flex items-center w-100 h3 bg-black-20">
                    <span class="fl ph3" @click="notificationsClear">
                        <i class="fa fa-times f3 tr white"></i>
                    </span>
                    ...
                    <span class="fr ph3" @click="toggleNotification">
                        <i class="fa fa-arrow-alt-right f3 tr white"></i>
                    </span>
                </nav>
                 <div class="h3"></div>
